...
`;
		...
		it('should parse boolean parameters as actual booleans', async () => {
			const testMacro = async (args: {flag?: boolean | string}): Promise<string> => {
				return `flag=${args.flag} type=${typeof args.flag}`;
			};
